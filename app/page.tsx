...
export default function BirthdayWish() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 text-center bg-gradient-to-r from-blue-500 to-red-500 text-white">
      ...
      <p className="mt-4 max-w-2xl text-lg sm:text-xl leading-relaxed bg-black/40 p-4 rounded-lg shadow-lg">
        This year, I hope you <strong>rock your fresh style</strong>, keep your <strong>wavy curls flowing</strong><strong></strong>
      </p>
      <p className="mt-4 max-w-2xl text-lg sm:text-xl leading-relaxed bg-black/40 p-4 rounded-lg shadow-lg">
        May your <strong>burgers always be juicy</strong>, your <strong></strong>, and your <strong>Git commits always be meaningful</strong>! 🎂🔥
      </p>
      <p className="mt-4 max-w-2xl text-lg sm:text-xl leading-relaxed bg-black/40 p-4 rounded-lg shadow-lg">
